...
import { ArrowLeft, ExternalLink, Github, Code, Zap } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
          ...
          >
            ...
            <div className="space-y-4">
              {project.features.map((feature, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-black dark:bg-white flex items-center justify-center text-white dark:text-black mt-1">
                    {index + 1}
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    {feature}
        ...
        {(project.challenges || project.outcomes) && (
          <motion.div
            ...
            className="mb-12"
          >
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">Challenges & Outcomes</h2>
            <div className="grid md:grid-cols-2 gap-8">
              {project.challenges && (
                <div className="bg-gray-100 dark:bg-gray-900 p-6 rounded-2xl">
